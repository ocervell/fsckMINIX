...
//Our system calls
#define PM_TOPICLOOKUP		 (PM_BASE + 48)
#define PM_TOPICCREATE		 (PM_BASE + 49)
#define PM_TOPICPUBLISHER	 (PM_BASE + 50)
#define PM_TOPICSUBSCRIBER   (PM_BASE + 51)
#define PM_PUBLISH			 (PM_BASE + 52)
#define PM_RETRIEVE			 (PM_BASE + 53)
#define PM_TOPICDELETE		 (PM_BASE + 54)
#define PM_TOPICUNPUBLISHER	 (PM_BASE + 55)
#define PM_TOPICUNSUBSCRIBER (PM_BASE + 56)
#define PM_TOPICMANAGEUSER	 (PM_BASE + 57)
#define PM_DELETE			 (PM_BASE + 58)
...
/*
#define VFS_RECOVERY    (VFS_BASE + 51)
#define VFS_DAMAGEINODE (VFS_BASE + 52)
#define VFS_DAMAGEDIR   (VFS_BASE + 53)
*/
